...
async def cb_start(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    await update.callback_query.message.reply_text(
        "📕 Как подготовить схему перед загрузкой\n\n"
        "Шаг 1 — Нанеси на схему цветовую разметку маркерами:\n\n"
        "Параллельные линии обозначь одним цветом.\n"
        "Каждая группа параллельных линий — своим цветом.\n"
        "Последовательные линии (не параллельные ни с чем) можно не красить.\n"
        "Трансформаторы не выделяй — они всегда последовательны.\n\n"
        "Пример:\n"
        "КЛ-10 кВ главная — без цвета\n"
        "ВЛ-0.4 от ТП-1 и ТП-2 идут параллельно — оба синим\n"
        "ВЛ-0.4 от ТП-3 и ТП-4 идут параллельно — оба красным\n\n"
        "Шаг 2 — Загрузи файл со схемой.",
    )
