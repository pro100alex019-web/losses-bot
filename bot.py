...
async def start_calc(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await q.message.reply_text(
        "📋 *Перед загрузкой схемы — требования к изображению:*\n\n"
        "✅ Схема должна быть *читаемой* (не смазанной)\n"
        "✅ На схеме должны быть подписаны:\n"
        "   • марки кабелей/проводов (ААБ2п 3×120, СИП 4×95 и т.д.)\n"
        "   • длины участков в метрах или км\n"
        "   • марки силовых трансформаторов (ТМ-400/10 и т.д.)\n\n"
        "⚠️ Если что-то не указано на схеме — допиши в комментарии.\n\n"
        "✏️ *Напиши комментарий* — в каких элементах считать потери "
        "(или напиши «все элементы»):",
        parse_mode="Markdown",
    )
