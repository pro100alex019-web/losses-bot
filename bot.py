...
async def cb_start(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    await update.callback_query.message.reply_text(
        "Шаг 1 — Подготовь схему\n\n"
        "На скане или фото схемы подчеркни элементы, потери в которых нужно посчитать.\n\n"
        "Правило подчёркивания:\n"
        "— Параллельные линии подчёркивай одним цветом\n"
        "— Последовательные линии подчёркивай разными цветами\n"
        "— Трансформаторы не подчёркивай — они учитываются автоматически\n\n"
        "Шаг 2 — Загрузи файл со схемой (не фото, а файл — чтобы не потерять качество).",
    )
